          ...
          <div className="relative">
            ...
            <ol className="space-y-6 pl-10 sm:pl-12">
              {process.map((step, index) => (
                ...
                >
                  <span className="absolute left-[-28px] top-6 flex h-6 w-6 items-center justify-center rounded-full border border-accent/40 bg-accent/20 text-xs font-semibold text-accent sm:left-[-38px]">
                    0{index + 1}
                  </span>
